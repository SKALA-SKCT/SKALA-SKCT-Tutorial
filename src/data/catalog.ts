    ...
    subtypes: [
      {
        id: "main-idea",
        name: "주제 파악",
        description: "글의 중심 내용과 필자의 핵심 주장 판단",
      ...
      },
      {
        id: "content-match",
        name: "일치와 불일치",
        description: "선지의 세부 정보가 지문과 같은지 판단",
      ...
      },
      {
        id: "inference",
        name: "추론",
        description: "지문에 근거해 숨은 결론과 의미 판단",
      ...
      },
      {
        id: "blank-inference",
        name: "빈칸 채우기",
        description: "앞뒤 문맥으로 빠진 핵심 내용 복원",
      ...
      },
      {
        id: "paragraph-order",
        name: "문단 배열",
        description: "접속어와 지시어로 문단의 순서 복원",
      ...
      },
      {
        id: "writing-method",
        name: "서술 방식",
        description: "비교, 대조, 예시 등 글의 전개 방식 판단",
    ...
    subtypes: [
      {
        id: "data-reading",
        name: "자료이해",
        description: "표와 그래프의 수치, 순위, 증감 추세 판단",
      ...
      },
      {
        id: "data-calculation",
        name: "자료계산",
        description: "비율, 증감률, 평균과 자료 간 차이 계산",
    ...
    subtypes: [
      {
        id: "arithmetic",
        name: "사칙연산",
        description: "수와 식의 연산 규칙을 이용한 계산",
      ...
      },
      {
        ...
        name: "거리, 속력, 시간",
        description: "이동 거리와 상대 속력, 소요 시간 계산",
      ...
      },
      {
        ...
        name: "경우의 수와 확률",
        description: "조건을 만족하는 조합과 발생 확률 계산",
      ...
      },
      {
        id: "work-rate",
        name: "작업량",
        description: "공동 작업과 기계별 생산 속도 계산",
    ...
    subtypes: [
      {
        id: "proposition",
        name: "명제추리",
        description: "명제의 참과 거짓, 대우 관계 판단",
      ...
      },
      {
        id: "line-order",
        name: "조건추리 줄 세우기",
        description: "앞뒤 조건을 이용해 순서와 위치 결정",
      ...
      },
      {
        id: "table-matching",
        name: "조건추리 테이블",
        description: "사람과 속성을 표로 연결해 조합 판단",
      ...
      },
      {
        ...
        name: "조건추리 가능 여부",
        description: "가능 조건과 불가능 조건을 표시해 정답 판단",
      ...
      },
      {
        id: "grid-arrangement",
        name: "조건추리 격자 배치",
        description: "2행 n열과 3행 3열 구조에 대상 배치",
      ...
      },
      {
        ...
        name: "조건추리 정보정리",
        description: "팀, 일정, 역할 조건을 종합해 경우 판단",
      ...
      },
      {
        id: "truth-game-basic",
        name: "진실게임 기본",
        description: "참말과 거짓말 조건으로 대상 판단",
      ...
      },
      {
        ...
        name: "진실게임 참 거짓 가정",
        description: "특정 진술의 참과 거짓을 가정해 경우 제거",
      ...
      },
      {
        ...
        name: "진실게임 복수 진술",
        description: "한 사람의 여러 진술과 진술 개수 조건 판단",
    ...
    subtypes: [
      {
        ...
        name: "등차수열과 등비수열",
        description: "일정한 차이 또는 비율 규칙으로 다음 수 판단",
      ...
      },
      {
        ...
        name: "여러 가지 수열",
        description: "교차, 계차, 재귀 규칙으로 다음 수 판단",
      ...
      },
      {
        ...
        name: "특수 규칙 수열",
        description: "제곱수, 소수, 묶음 연산 등 특수 규칙 판단",
