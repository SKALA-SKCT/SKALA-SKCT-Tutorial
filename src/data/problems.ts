...
export const PROBLEMS: Problem[] = [
  ...VERBAL_TUTORIAL_PROBLEMS,
  {
    ...
    steps: [
      ...
      {
        narration:
          "그 결과 엔비디아 주가가 17% 폭락하고, SK하이닉스와 TSMC 같은 반도체 기업도 큰 타격을 입었습니다. 반면 애플은 상승했죠. 즉 ①의 구체적 설명은 ‘엔비디아와 반도체 기업의 주가’에 관한 것입니다.",
        highlight: ["p6", "p7", "p8"],
      },
      {
        narration:
...

  {
    ...
    steps: [
      ...
      {
        narration:
          "보기는 ‘국내에서도’ 항노화 화장품과 재생 의학에 AI 유전자 분석을 활용했다는 내용입니다. ‘국내에서도’라는 말은 앞에 ‘해외 사례’가 먼저 나온다는 신호예요. 또 글의 주제가 ‘노화’라는 것도 알 수 있습니다.",
        highlightBox: true,
      },
      {
      ...
      {
        narration:
          "다음 문장을 보면 ‘이처럼 노화 예방뿐 아니라 항노화 화장품과 재생 의학 분야에서도 주목받는다’고 합니다. 보기도 바로 이 ‘항노화 화장품’을 말하고 있어요. 그래서 보기는 (D)에 들어갑니다. 정답은 ④ (D)입니다.",
        highlight: ["s6", "posD"],
        highlightChoices: ["4"],
        reveal: true,
      },
